...
root.resizable(0,0)
root.iconbitmap('C:/Users/Omen/Desktop')
...
button_mul = Button(root, text="x", padx=41, pady=20, command=button_multiply)
...
button_equal = Button(root, text="=", padx=150, pady=20, command=button_equal)
#button_cos = Button(root, text="=", padx=150, pady=20, command=button_cos)


#Puting the buttons on the screen
