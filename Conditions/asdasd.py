# Simple Calculator
# by Shashanka Dhungana
# Topics: tkinter, grid geometry, eval, try/except, lambda
...
label_result.grid(row=0, column=0, columnspan=1)

button_1 = tkinter.Button(root, fg= "black", text="1", command=lambda: add("1"))
